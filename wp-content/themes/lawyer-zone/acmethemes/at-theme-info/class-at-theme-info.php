...
if ( ! class_exists( 'Lawyer_Zone_Theme_Info' ) ) {
    class Lawyer_Zone_Theme_Info{
        ...
        public function at_theme_info_welcome_admin_notice() {
            ...
            echo ( '<p>' . sprintf( __('Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our %2$swelcome page%3$s.','lawyer-zone'), $this->theme_name, '<a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '">', '</a>' ) . '</p><p><a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '" class="button text-decoration-none">' . sprintf( __('Get started with %s','lawyer-zone'), $this->theme_name ) . '</a></p>' );
            echo '</div>';
        }
